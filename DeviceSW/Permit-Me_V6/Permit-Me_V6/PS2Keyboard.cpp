...
ICACHE_RAM_ATTR void PS2Kbd::kbdInterrupt0() {
    keyboard0Ptr->interruptHandler();
}
ICACHE_RAM_ATTR void PS2Kbd::kbdInterrupt1() {
    keyboard1Ptr->interruptHandler();
}
ICACHE_RAM_ATTR void PS2Kbd::kbdInterrupt2() {
    keyboard2Ptr->interruptHandler();
}
ICACHE_RAM_ATTR void PS2Kbd::kbdInterrupt3() {
    keyboard3Ptr->interruptHandler();
}
ICACHE_RAM_ATTR void PS2Kbd::kbdInterrupt4() {
   keyboard4Ptr->interruptHandler();
}
ICACHE_RAM_ATTR void PS2Kbd::kbdInterrupt5() {
    keyboard5Ptr->interruptHandler();
}
ICACHE_RAM_ATTR void PS2Kbd::kbdInterrupt6() {
    keyboard6Ptr->interruptHandler();
}
ICACHE_RAM_ATTR void PS2Kbd::kbdInterrupt7() {
