...
const char* host = "192.168.49.50";
const char* fwURLLoc = "/fw_update/";
...
{
  String fwURL = String ("http://") + host + fwURLLoc + devType;
...
#ifdef _KBRD    //KEYBORD / OTHER
  Serial.print("PM_KBRD VER : ");
  Serial.print(VERSION);
  delay(2000);
#else         //RFID
  Serial.print("PM_RFID VER : ");
  Serial.println(VERSION);
#endif
